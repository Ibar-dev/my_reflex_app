            ...
            rx.flex(
                ...
                rx.vstack(
                    ...
                    rx.box(
                        rx.hstack(
                            rx.vstack(
                                rx.text("+30%", font_size="2rem", font_weight="800", color="#FF6B35"),
                                rx.text("Potencia", font_size="0.9rem", color="rgba(255,255,255,0.9)"),
                                align="center",
                                spacing="1",
                            ),
                            rx.box(width="1px", height="40px", bg="rgba(255,255,255,0.2)"),
                            rx.vstack(
                                rx.text("-15%", font_size="2rem", font_weight="800", color="#FF6B35"),
                                rx.text("Consumo", font_size="0.9rem", color="rgba(255,255,255,0.9)"),
                                align="center",
                                spacing="1",
                            ),
                            rx.box(width="1px", height="40px", bg="rgba(255,255,255,0.2)"),
                            rx.vstack(
                                rx.text("100%", font_size="2rem", font_weight="800", color="#FF6B35"),
                                rx.text("Garantía", font_size="0.9rem", color="rgba(255,255,255,0.9)"),
                                align="center",
                                spacing="1",
                            ),
                            spacing="6",
