...
def fuel_selection() -> rx.Component:
    ...
    return rx.vstack(
        rx.heading("1. Selecciona el tipo de combustible", size="6", color="white", margin_bottom="6"),
        rx.hstack(
            rx.button(
                rx.vstack(
                    rx.text("⛽", font_size="3rem"),
                    rx.text("Diésel", font_weight="600", color="white"),
                    spacing="2",
                    align="center"
                ),
                bg="#2D2D2D",
            ...
            rx.button(
                rx.vstack(
                    rx.text("⛽", font_size="3rem"),
                    rx.text("Gasolina", font_weight="600", color="white"),
                    spacing="2",
                    align="center"
                ),
                bg="#2D2D2D",
...
def vehicle_selector() -> rx.Component:
    ...
    return rx.box(
        rx.container(
            rx.vstack(
                rx.heading("Encuentra tu vehículo", size="8", color="white", text_align="center", mb="8"),
                rx.box(
                    rx.cond(
